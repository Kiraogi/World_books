...
class Form_add_author(forms.Form):
    first_name = forms.CharField(label="Имя автора", max_length=50)
    last_name = forms.CharField(label="Фамилия автора", max_length=50)
...
# Форма для изменения сведений об авторе
