    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.CharField(help_text='Введите год издания книги', max_length=4, verbose_name='Год издания книги')),
                ('summary', models.TextField(help_text='Введите краткое описание книги', max_length=1000, verbose_name='Аннотация книги')),
                ('isbn', models.CharField(help_text='Введите ISBN книги (13  символов)', max_length=13, verbose_name='ISBN книги')),
                ('price', models.DecimalField(decimal_places=2, help_text='Введите цену книги', max_digits=7, verbose_name='Цена книги (руб.)')),
                ('photo', models.ImageField(help_text='Введите изображение обложки', upload_to='images', verbose_name='Изображение обложки')),
                ('author', models.ManyToManyField(help_text='Выберите автора (авторов) для книги', to='catalog.author', verbose_name='Автор (авторы) книги')),
                ...
                ('publisher', models.ForeignKey(help_text='Выберите издательство для книги', null=True, on_delete=django.db.models.deletion.CASCADE, to='catalog.publisher', verbose_name='Издательство')),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('inv_nom', models.CharField(help_text='Введите инвентарный номер экземпляра книги', max_length=20, null=True, verbose_name='Инвентарный номер')),
                ...
                ('status', models.ForeignKey(help_text='Изменить состояние экземпляра книги', on_delete=django.db.models.deletion.CASCADE, to='catalog.status', verbose_name='Статус экземпляра книги')),
            ],
            options={
                'ordering': ['due_back'],
            },
